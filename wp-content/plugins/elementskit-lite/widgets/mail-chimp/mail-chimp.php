...
class ElementsKit_Widget_Mail_Chimp extends Widget_Base {
    ...
    protected function render_raw( ) {
		...
		<form id="subscribeLetterForm" method="post" class="ekit-mailChimpForm" data-listed="<?php echo esc_attr($ekit_mail_chimp_select_listed_id);?>" data-success-message="<?php echo esc_attr($ekit_mail_chimp_success_message); ?>" data-success-opt-in-message="<?php echo esc_attr($ekit_mail_chimp_opt_in_success_message)?>">
			...
			<input type="hidden" name="double_opt_in" value="<?php echo esc_attr($ekit_mail_chimp_double_opt_in)?>">
				...
				<?php endif; ?>
					...
					<div class="ekit_submit_input_holder elementskit_input_wraper">
						<button type="submit" aria-label="submit" class="ekit-mail-submit" name="ekit_mail_chimp">SUBSCRIBE AND <?php if(($ekit_mail_chimp_submit_icon_show == 'yes') && ($ekit_mail_chimp_submit_icons != '') && ($ekit_mail_chimp_submit_icon_position == 'before')): ?> 
		...
		<script type="text/javascript">	
			document.addEventListener("DOMContentLoaded", function() {
				...
				const myForm = document.getElementById("subscribeLetterForm");

				// Attach the event listener to the form's submit event
				myForm.addEventListener("submit", function(event) {
					event.preventDefault();
				    tracker.onCustomEvent("newsletter_subscriber", {
